...
class Magt_Penilaian extends CI_Model
{
    ...
    public function get_penilaian_count_with_date()
    {
        ...
        //     $this->db->where('tgl_penilaian >=', $dari_tgl);
        //     $this->db->where('tgl_penilaian <=', $sampai_tgl);
        // }
    ...
    public function get_penilaian_count_with_filter_date($dari_tgl = null, $sampai_tgl = null)
    {
        // die(var_dump($dari_tgl));
        $this->db->select('
            SUM(pendapat1 = "Sangat Memuaskan") as pendapat1_sangat_memuaskan,
            SUM(pendapat1 = "Memuaskan") as pendapat1_memuaskan,
            SUM(pendapat1 = "Kurang Memuaskan") as pendapat1_kurang_memuaskan,
