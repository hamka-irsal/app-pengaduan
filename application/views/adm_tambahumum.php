		...
		<div class="row">
			...
			<div class="panel panel-default">
              <div class="panel-heading">
                <center><h3><strong>Tambah Kegiatan</strong></h3></center>
              </div>
              ...
              <div class="tab-content"><!-- 
                <div class="active tab-pane fade in" id="halaman_1"> -->
                 <div class="box-body">
                  ...
                  <form action="<?php echo base_url('admin/tambah_umum') ?>" method="POST" role="form" enctype="multipart/form-data">

                <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>Visi :</label>
                    <input type="text" class="form-control" name="visi" id="visi" placeholder="Silahkan isi Kegiatan">
                </div>

                <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>Nama Kegiatan:</label>
                    <input type="text" class="form-control" name="misi" id="misi" placeholder="Silahkan isi Kegiatan">
                </div>

                <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>Nama Kegiatan:</label>
                    <input type="text" class="form-control" name="janji_layanan" id="janji_layanan" placeholder="Silahkan isi Kegiatan">
                </div>

                <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>Nama Kegiatan:</label>
                    <input type="text" class="form-control" name="tupoksi_kerja" id="tupoksi_kerja" placeholder="Silahkan isi Kegiatan">
                </div>

                <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>Nama Kegiatan:</label>
                    <input type="text" class="form-control" name="alur_pelaporan" id="alur_pelaporan" placeholder="Silahkan isi Kegiatan">
                </div>

                <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>Nama Kegiatan:</label>
                    <input type="text" class="form-control" name="struktur_organisasi" id="struktur_organisasi" placeholder="Silahkan isi Kegiatan">
                </div>
