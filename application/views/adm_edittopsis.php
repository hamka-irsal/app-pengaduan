		...
		<div class="row">
			...
			<div class="panel panel-default">
              <div class="panel-heading">
                <center><h3><strong>Edit Data Topsis</strong></h3></center>
              </div>
              ...
              <div class="tab-content"><!-- 
                <div class="active tab-pane fade in" id="halaman_1"> -->
                 <div class="box-body">
                  ...
                  <form action="<?= site_url('admin/update_topsis') ?>" method="post">
                  <input type="hidden" name="id_pengaduan" value="<?= $pengaduan['id_pengaduan']; ?>">
                  <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>Biaya:</label>
                    <input type="text" class="form-control" name="biaya" id="biaya" value="<?= $pengaduan['biaya'] ?>">
                  </div>

                  <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>SDM:</label>
                    <input type="text" class="form-control" name="sdm" id="sdm" value="<?= $pengaduan['sdm'] ?>">
                  </div>

                  <div class="form-group" style="margin-left: 15px; margin-right:15px">
                    <label>Regulasi:</label>
                    <input type="text" class="form-control" name="regulasi" id="regulasi" value="<?= $pengaduan['regulasi'] ?>">
                  </div>
                  ...
                  <div style="margin-left: 90%">
                    <button class="btn btn-success" name="submit" type="submit" style="margin-top: 20px; width:80px">simpan</button>
                  </div>
                </div>
                <!-- /.tab-pane -->
              </form>
