        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <center>
                    <div class="col-lg-12">
                        <h1 class="page-header"><b>Data Penilaian</b></h1>
                    </div>
                    </center>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <form method="post" action="<?php echo site_url('admin/caripenilaian'); ?>">
                    ...
                    <!-- <a  href=<?php echo base_url('admin/tambah_umum')?> class="btn btn-primary btn-md" style="margin-left: 74%"><span class="fa fa-plus"></span> Tambah Kegiatan </a> -->
                        <div class="panel-heading">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-hover" class="text-center">
                                    <thead>
                                    ...
                                    <?php foreach ($penilaian as $data): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data->pendapat1; ?></td>
                                            <td><?php echo $data->pendapat2; ?></td>
                                            <td><?php echo $data->pendapat3; ?></td>
                                            <td><?php echo $data->pendapat4; ?></td>
                                            <td><?php echo $data->pendapat5; ?></td>
