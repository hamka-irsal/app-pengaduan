  ...
  <main class="main">
    ...
    <section  class="more-services section">
      ...
      <div class="container section-title" data-aos="fade-up"><br>
        <h2>Foto Kegiatan</h2>
        <p>UPT. Teknologi Permesinan & Peralatan Penunjang Akademik (TP3A)</p>
        ...
        <div class="row gy-4">
         <?php foreach ($kegiatan as $item): ?>
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              <img src="<?php echo base_url('assets/gambar/' . $item['foto']); ?>" class="img-fluid" alt="<?php echo $item['nama_kegiatan']; ?>">
