                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                            ...
                            <?php if ($pengaduan): ?>
                                ...
                                <form action="<?= site_url('admin/kirim/' . $pengaduan->id_pengaduan); ?>" method="post">
                                    <label for="pesan">Pesan Umpan Balik:</label><br>
                                    <textarea name="pesan" id="pesan" rows="5" cols="50" ></textarea><br><br>
