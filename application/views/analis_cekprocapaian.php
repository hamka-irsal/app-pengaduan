    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="report-container">
                    <h3>Daftar File Program Capaian yang Sudah Diupload</h3>
                    <?php if (empty($files)): ?>
                    ...
                    <?php else: ?>
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $file; ?></td>
                                    <td><a href="<?php echo base_url('uploads_file_capaian/'.$file); ?>" target="_blank">Lihat</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                ...
                <div class="buttons">
                    <a href="<?php echo base_url('analis/procapaian') ?>" class="login-btn">Tambah Upload</a>
                </div>
                </center>
                <!-- /.col-lg-12 -->
            </div>
