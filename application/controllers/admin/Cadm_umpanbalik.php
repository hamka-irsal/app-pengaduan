...
class Cadm_umpanbalik extends BaseController {
	...
	public function index()
	{
		...
		$data['pengaduan']=$this->Madm_umpanbalik->pengaduan_masuk($id_user);
		$this->load->view('adm_umpanbalik',$data);
		// $this->load->view('pengaduan_list');
	}

	public function detail($id)
	{
		$data['kategori']=$this->Madm_umpanbalik->kategori();
		$data['detail_pengaduan']=$this->Madm_umpanbalik->detail_pengaduan($id);
		$data['level']=$this->Madm_umpanbalik->level();	//ke level tujuan

		$this->load->view('admdetail_umpanbalik',$data);
	}
	...
	public function ubah()
	{
		...
		$this->Madm_umpanbalik->ubah($data,$id_pengaduan);
	...
	public function tambah_kategori()
	{
		...
		$this->Madm_umpanbalik->simpan($data);
	...
	public function edit_skala_prioritas()
	{
		...
		$this->Madm_umpanbalik->edit_skala_prioritas($data, $id_pengaduan);
	...
	{ 
	   ...
	   public function konfirmasi()
	   {
		   	...
		   	$id_user = $this->session->userdata('id_user');
		   	// $rs = $this->Madm_umpanbalik->getByEmail($email);
		...
		public function proses_topsis() {
			try {
				// $pengaduan = $this->Madm_umpanbalik->pengaduan_masuk();
				$id_user = $this->session->userdata('id_user');
				$data['pengaduan']=$this->Madm_umpanbalik->pengaduan_masuk($id_user);
				...
				foreach ($pengaduan as $p) {
					...
					$this->Madm_umpanbalik->update_prioritas($p->id_pengaduan, $nilai_prioritas);
				}
